...
$(document).ready(function() {
   ...
   if (!location.href.match(/main$/i)&&(!location.hash||location.hash=='#main')) {
...
//        if(h ==='#undefined' ){
//            h = 'main#client_dashboard'
//        }
        link =  h.replace(/^\#+/, ""),
        id = link.replace(/[\/\.]/,"-");
       var preloader = $("<div style='background: none repeat scroll 0% 0% white; height: 800px; line-height: 800px;'><div id='loading-container1'><p id='loading-content1'><img id='loading-graphic1' width='16' height='16' src='template/images/ajax-loader-trans.gif' />Loading...</p></div></div>");
        $.ajax(link, {
            dataType: "html",
            cache: false,
            beforeSend:function(){
                preloader.appendTo($("#main-content"));
            },
...
//delete confirmation popup
 $('<div id="delete-confirm" title="Delete item"><p id="err"><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><b></b></p></div>').appendTo('body');
 $("#delete-confirm").dialog({autoOpen: false,modal: true, height:170,width:360});

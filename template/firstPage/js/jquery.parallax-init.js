/*
Custom jQuery script for Mosha Template
author: Curious Design 
*/
		...
		viewing : function(){
			...
			if (pos < scroll.stories[0].offset.bottom-60-minus) {
				...
				$('.story').eq(1).addClass('viewing'); 
                                $('iframe.video1').css("display","block");
			}
				...
				$('.story').eq(2).addClass('viewing'); 
                                  $('iframe.video1').css("display","none");
			}
...
$(document).ready(function() { 
	...
	$('#Nav a, .to_top').not('.get_started, .talk_to_us, .login, .change_lang_login, .refresh').click(function(){
	...
	$('.talk_to_us, .login, .create, .forgot , .close').click(function(){
            
                $('iframe.video1').css("display","none");
            
               if($(this).hasClass('login')){
                    scroll.login.init();
                }else if($(this).hasClass('talk_to_us')){
                    scroll.contact.init();
